 ...
 * Upgrade presets for OpenCV 4.2.0, FFmpeg 4.2.2, HDF5 1.10.6, MKL 2020.0, MKL-DNN 0.21.3, DNNL 1.1.3, CPython 3.7.6, NumPy 1.18.1, LLVM 9.0.1, CUDA 10.2, cuDNN 7.6.5, NCCL 2.5.6, TensorFlow 1.15.2, TensorRT 7.0, ALE 0.6.1, Leptonica 1.79.0, Tesseract 4.1.1, ONNX Runtime 1.1.0, Qt 5.14.0, Skia 1.68.1, and their dependencies
